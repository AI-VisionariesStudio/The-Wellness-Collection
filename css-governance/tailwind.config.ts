...
const config: Config = {
  ...
  // ── Safelist: classes that MUST always be available ──
  safelist: [],
  ...
  theme: {
    ...
    fontSize: typography.fontSize as unknown as Config['theme'] extends { fontSize: infer T } ? T : never,
    ...
    // ── Extend only for layout-specific values ──
    extend: {
      maxWidth: {
